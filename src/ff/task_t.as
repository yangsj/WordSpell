...
import org.apache.thrift.protocol.*;
  ...
  public class task_t implements TBase   {
    private static const STRUCT_DESC:TStruct = new TStruct("task_t");
    private static const TASK_ID_FIELD_DESC:TField = new TField("task_id", TType.I32, 1);
    private static const TASK_TYPE_FIELD_DESC:TField = new TField("task_type", TType.I32, 2);
    private static const DESC_FIELD_DESC:TField = new TField("desc", TType.STRING, 3);
    private static const STATUS_FIELD_DESC:TField = new TField("status", TType.I32, 4);
    private static const PROGRESS_FIELD_DESC:TField = new TField("progress", TType.MAP, 5);
    private static const COIN_AWARD_FIELD_DESC:TField = new TField("coin_award", TType.I32, 6);
    private static const EXP_AWARD_FIELD_DESC:TField = new TField("exp_award", TType.I32, 7);
    private static const ITEM_AWARD_FIELD_DESC:TField = new TField("item_award", TType.MAP, 8);

    private var _task_id:int;
    public static const TASK_ID:int = 1;
    private var _task_type:int;
    public static const TASK_TYPE:int = 2;
    private var _desc:String;
    public static const DESC:int = 3;
    private var _status:int;
    public static const STATUS:int = 4;
    private var _progress:Dictionary;
    public static const PROGRESS:int = 5;
    private var _coin_award:int;
    public static const COIN_AWARD:int = 6;
    private var _exp_award:int;
    public static const EXP_AWARD:int = 7;
    private var _item_award:Dictionary;
    public static const ITEM_AWARD:int = 8;

    private var __isset_task_id:Boolean = false;
    private var __isset_task_type:Boolean = false;
    ...
    public static const metaDataMap:Dictionary = new Dictionary();
    {
      ...
      metaDataMap[TASK_TYPE] = new FieldMetaData("task_type", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.I32));
      ...
      metaDataMap[STATUS] = new FieldMetaData("status", TFieldRequirementType.DEFAULT, 
          new FieldValueMetaData(TType.I32));
      metaDataMap[PROGRESS] = new FieldMetaData("progress", TFieldRequirementType.DEFAULT, 
    ...
    {
      FieldMetaData.addStructMetaDataMap(task_t, metaDataMap);
    }
    ...
    public function get task_type():int {
      return this._task_type;
    }

    public function set task_type(task_type:int):void {
      this._task_type = task_type;
      this.__isset_task_type = true;
    }

    public function unsetTask_type():void {
      this.__isset_task_type = false;
    }

    // Returns true if field task_type is set (has been assigned a value) and false otherwise
    public function isSetTask_type():Boolean {
      return this.__isset_task_type;
    }
    ...
    public function get progress():Dictionary {
      return this._progress;
    }

    public function set progress(progress:Dictionary):void {
      this._progress = progress;
    }

    public function unsetProgress():void {
      this.progress = null;
    }

    // Returns true if field progress is set (has been assigned a value) and false otherwise
    public function isSetProgress():Boolean {
        ...
        switch (field.id)
        {
          ...
          case PROGRESS:
            if (field.type == TType.MAP) {
              {
                var _map53:TMap = iprot.readMapBegin();
                this.progress = new Dictionary();
                for (var _i54:int = 0; _i54 < _map53.size; ++_i54)
                {
                  var _key55:int;
                  var _val56:Array;
                  _key55 = iprot.readI32();
                  {
                    var _list57:TList = iprot.readListBegin();
                    _val56 = new Array();
                    for (var _i58:int = 0; _i58 < _list57.size; ++_i58)
                    {
                      var _elem59:int;
          ...
          case ITEM_AWARD:
            if (field.type == TType.MAP) {
              {
                var _map60:TMap = iprot.readMapBegin();
                this.item_award = new Dictionary();
                for (var _i61:int = 0; _i61 < _map60.size; ++_i61)
                {
                  var _key62:int;
                  var _val63:int;
                  _key62 = iprot.readI32();
                  _val63 = iprot.readI32();
                  this.item_award[_key62] = _val63;
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public function write(oprot:TProtocol):void {
      ...
      if (this.progress != null) {
        ...
        {
          var _sizeCounter65:int = 0;
          for (var _key64:* in this.progress) {
            _sizeCounter65++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.LIST, _sizeCounter65));
          for (var elem66:* in this.progress)          {
            oprot.writeI32(elem66);
            {
              oprot.writeListBegin(new TList(TType.I32, this.progress[elem66].length));
              for each (var elem67:* in this.progress[elem66])              {
      ...
      if (this.item_award != null) {
        oprot.writeFieldBegin(ITEM_AWARD_FIELD_DESC);
        {
          ...
          for (var _key68:* in this.item_award) {
            _sizeCounter69++;
          }
          oprot.writeMapBegin(new TMap(TType.I32, TType.I32, _sizeCounter69));
          for (var elem70:* in this.item_award)          {
            oprot.writeI32(elem70);
            oprot.writeI32(this.item_award[elem70]);
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
    ...
    public function toString():String {
      var ret:String = new String("task_t(");
